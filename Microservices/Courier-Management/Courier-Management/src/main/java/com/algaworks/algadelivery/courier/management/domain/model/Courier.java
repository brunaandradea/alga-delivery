...
public class Courier {
    ...
    public static Courier brandNew(String nome, String phone) {
        Courier courier = new Courier();
        courier.setId(UUID.randomUUID());
        courier.setName(nome);
        courier.setPhone(phone);
        courier.setFulfilledDeliveriesQuantity(0);
        courier.setPendingDeliveriesQuantity(0);
        courier.setLastFulfilledDeliveryAt(null);
    ...
    public void assing(UUID deliveryId) {
        this.pendingDeliveries.add(
                AssignedDelivery.pendingDelivery(deliveryId, this)
        );
